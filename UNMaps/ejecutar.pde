...
void ejecutar(int a) {
  ...
  PVector posbo= new PVector((width*3)/4, (height+img.height)/2+50);//NUEVA POSICION DE BOTON
  ...
  Boton borrar=new BotonRect(clg, posbo, 8, 15, 28, dimeng, "Borrar", 0);//NUEVO BOTON
